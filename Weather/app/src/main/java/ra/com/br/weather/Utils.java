...
public abstract class Utils {
    ...
    public static int getIconId(String icon){
        switch (icon){
            ...
            case "02d": return R.drawable.cloud;
            case "02n": return R.drawable.night_cloud;
            case "03d": return R.drawable.partially_cloud;
            case "03n": return R.drawable.partially_cloud;
            case "04d": return R.drawable.partially_cloud;
            case "04n": return R.drawable.partially_cloud;
            case "09d": return R.drawable.showers;
            case "09n": return R.drawable.showers;
            case "10d": return R.drawable.rain;
            ...
            case "50d": return R.drawable.twister;
            case "50n": return R.drawable.twister;
